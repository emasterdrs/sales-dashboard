                    ...
                    <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6 md:gap-8 mb-6 md:mb-8">
                        ...
                        <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4 md:gap-6 shrink-0 w-full md:w-auto">
                            ...
                            <div className="flex flex-col gap-4 shrink-0 w-full sm:w-[320px]">
                                ...
                                {/* 하단: 기준 및 단위 구성 (2열 세로 배치) */}
                                <div className="grid grid-cols-2 gap-3">
                                    {/* 금액 선택 블록 */}
                                    <div className="flex flex-col gap-1.5">
                                        <button
                                            onClick={() => setMetricType('amount')}
                                            className={`w-full py-1.5 rounded-lg text-[10px] font-bold transition-all border ${metricType === 'amount' ? 'bg-indigo-500/20 text-indigo-300 border-indigo-500/50 shadow-lg' : 'bg-white/5 text-slate-500 border-transparent hover:text-slate-400'}`}
                                        >
                                            금액 기준
                                        </button>
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <button
                                            ...
                                            className={`w-full py-1.5 rounded-lg text-[10px] font-bold transition-all border ${metricType === 'weight' ? 'bg-indigo-500/20 text-indigo-300 border-indigo-500/50 shadow-lg' : 'bg-white/5 text-slate-500 border-transparent hover:text-slate-400'}`}
                                        >
                                            중량 기준
                                        </button>
                                        <div className="relative">
